...
export default function SelectedImpact() {
  return <section id="impact" className="section section--ink"><div className="shell">
    <SectionHeading light eyebrow="Selected Impact" title="Architecture leadership across essential systems" description="Representative work across public-sector identity, healthcare, financial services, and connected platforms—presented without confidential implementation details."/>
