...
// ✅ Removed PDF completely
const PUB_LINK_COLORS = {
  'IEEE Xplore':'#60a5fa',
  'ResearchGate':'#34d399',
  'Google Scholar':'#fb923c',
}

// ✅ Clean link resolver (no PDF)
  ...
  return (
      <div className="flex flex-wrap gap-2 mt-4">
        {Object.entries(linkMap)
            .filter(([_, href]) => href && href.trim() !== '') // ✅ no empty links
            .map(([label, href]) => {
              const color = PUB_LINK_COLORS[label]
  ...
  return (
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <h2
              className="text-section reveal mb-4"
          ...
          <p
              className="reveal reveal-d1 mb-12"
              style={{
                color:'var(--text2)',
                fontSize:'1.05rem',
                maxWidth:'560px',
          ...
          >
            8+ IEEE and international journal publications spanning AI security,
            zero trust, federated learning, and healthcare informatics.
          </p>
